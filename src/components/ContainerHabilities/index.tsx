...
const ContainerHabilities: React.FC = () => {
  return (
    <>
      <div style={{ position: "relative" }} className="Desktop">
        <motion.div
          drag
          dragConstraints={{
            top: -5,
                  ...
                  <ContentCol>
                    <Header>
                      ...
                      <TextContent>
                        ...
                        <TextHeader>
                          I like to work with competent teams, I also love to
                          code the project from the beginning
                        </TextHeader>
                      </TextContent>
                    </Header>
                    <Middle>
                  ...
                  <ContentCol>
                    <Header>
                      ...
                      <TextContent>
                        ...
                        <TextHeader>
                          I started programming systems on the backend and today
                          I manage to develop both areas with mastery
                        </TextHeader>
                      </TextContent>
                    </Header>
