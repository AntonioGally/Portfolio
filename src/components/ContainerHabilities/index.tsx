            ...
            <ContentCol>
              <Header>
                ...
                <TextContent>
                  ...
                  <TextHeader>
                    I like to work with competent teams, I also love to code the
            ...
            <ContentCol>
              <Header>
                ...
                <TextContent>
                  ...
                  <TextHeader>
                    I finished my technical course recently, and I have several
        ...
        <Carousel itemsToShow={1} disableArrowsOnEnd={false}>
          ...
          <ContentCol>
            ...
            <Middle style={{ marginTop: "11%" }}>
              <TextContent>
                <TitleMiddle>My Experiences:</TitleMiddle>
                <TextMiddle>Technician, Extra Classes, Certificates</TextMiddle>
              </TextContent>
            </Middle>
            <End>
              <TextContent>
